...
Consulte `docs/security.md` para boas práticas sobre gerenciamento de segredos, como remover um segredo se ele foi accidentalmente commitado, e recomendações de rotação.
