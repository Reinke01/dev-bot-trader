                ...
                for acao in acoes:
                    ...
                    if acao.get('acao') == 'comprar':
                        ...
                        if not is_simulator:
                            ...
                            logger.info(LogCategory.SYSTEM, "🛠️ MODO SIMULADOR: Pulando abertura real de COMPRA", "trade_entry_evaluator_parser", symbol=cripto)
                    ...
                    if acao.get('acao') == 'vender':
                        ...
                        if not is_simulator:
                            ...
                            logger.info(LogCategory.SYSTEM, "🛠️ MODO SIMULADOR: Pulando abertura real de VENDA", "trade_entry_evaluator_parser", symbol=cripto)
